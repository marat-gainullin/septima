...
import com.septima.script.LpcTransient;
...
public class Report implements HasPublished, LpcTransient {
    ...
    protected static String generateReportPath(String aFileName, String aFormat) {
        ...
        reportPath += ClientConstants.USER_HOME_SEPTIMA_DIRECTORY_NAME;
        ...
        String suffix = "." + (aFormat != null ? aFormat : SeptimaFiles.REPORT_LAYOUT_EXTENSION_X);
