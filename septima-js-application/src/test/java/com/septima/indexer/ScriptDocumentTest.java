...
public class ScriptDocumentTest {
    ...
    public void jQueryLargeFileMinified() throws IOException {
        URL resource = ScriptDocumentTest.class.getClassLoader().getResource("com/eas/client/indexer/reg-exp-literal.min-jquery.js");
        ScriptDocument.parse(readUrl(resource), "jquery-large-min");
    }

    @Test
    public void jQueryLargeFile() throws IOException {
        URL resource = ScriptDocumentTest.class.getClassLoader().getResource("com/eas/client/indexer/reg-exp-literal-jquery.js");
    ...
    public void leafletLargeFile() throws IOException {
        URL resource = ScriptDocumentTest.class.getClassLoader().getResource("com/eas/client/indexer/numeric-literal-leaflet.js");
