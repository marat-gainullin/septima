...
public class RPCRequestHandler extends RequestHandler<RPCRequest, RPCRequest.Response> {
    ...
    public static final String MODEL_SAVE_ERROR_MSG = "While attempting transform save model indices unactual server module %s";
    ...
    public static final String RERUN_MSG = "About transform re-run server module {0}";

    /**
     * @param aServerCore
     * @param aRequest
     */
    public RPCRequestHandler(SeptimaApplication aServerCore, RPCRequest aRequest) {
    ...
    public static final String BOTH_IO_MODELS_MSG = "Method {0} in module {1} attempts transform call a callback more than once or it returns value and calls a callback. Sync and async IO models both are not allowed. You should make a choice.";
}
