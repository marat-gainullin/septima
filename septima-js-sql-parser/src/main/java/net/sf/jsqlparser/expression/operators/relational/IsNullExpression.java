...
public class IsNullExpression implements Expression {
    ...
    public String toString() {
        return (prior ? (getCommentPrior() != null ? getCommentPrior()+" " : "") + "PRIOR " : "") 
               + leftExpression + (getCommentIs() != null ? " "+getCommentIs() : "")+ " IS " 
               + (not ? (getCommentNot() != null ? getCommentNot()+" " : "") + "NOT " : "") 
               + (getCommentNull() != null ? getCommentNull()+" " : "") + "NULL";
    }

    /**
     * @return the commentIs
     */
    public String getCommentIs() {
        return commentIs;
    }
    ...
    /**
     * @return the commentNull
     */
    public String getCommentNull() {
        return commentNull;
    }
