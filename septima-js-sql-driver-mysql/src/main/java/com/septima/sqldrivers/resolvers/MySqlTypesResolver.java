...
public class MySqlTypesResolver implements TypesResolver {
    ...
    private static final Map<String, String> rdbmsTypes2ApplicationTypes = new LinkedHashMap<>(){{
        ...
        put("mediumint", ApplicationTypes.NUMBER_TYPE_NAME);
        ...
        put("tinytext", ApplicationTypes.STRING_TYPE_NAME);
        put("long varchar", ApplicationTypes.STRING_TYPE_NAME);
        put("text", ApplicationTypes.STRING_TYPE_NAME);
        put("mediumtext", ApplicationTypes.STRING_TYPE_NAME);
        put("longtext", ApplicationTypes.STRING_TYPE_NAME);
        put("date", ApplicationTypes.DATE_TYPE_NAME);
        put("time", ApplicationTypes.DATE_TYPE_NAME);
        put("year", ApplicationTypes.DATE_TYPE_NAME);
        put("enum", ApplicationTypes.STRING_TYPE_NAME);
        put("set", ApplicationTypes.STRING_TYPE_NAME);
        put("binary", null);
        put("varbinary", null);
        put("tinyblob", null);
        put("blob", null);
        ...
        put("multipoint", ApplicationTypes.GEOMETRY_TYPE_NAME);
        put("multilinestring", ApplicationTypes.GEOMETRY_TYPE_NAME);
        put("multipolygon", ApplicationTypes.GEOMETRY_TYPE_NAME);
        put("geometrycollection", ApplicationTypes.GEOMETRY_TYPE_NAME);
    }};
