...
import com.septima.client.sqldrivers.GenericSqlDriver;
import java.sql.*;
...
public class SqlUtils {
    ...
    public static SqlQuery validateTableSqlQuery(String aTableDatasource, String tableName, String tableSchemaName, Databases aClient) throws Exception {
        return validateTableSqlQuery(aTableDatasource, tableName, tableSchemaName, aClient, true);
    }

    public static SqlQuery validateTableSqlQuery(String aTableDatasource, String aTableName, String aTableSchemaName, Databases aClient, boolean forceMdQuery) throws Exception {
        ...
        Metadata mdCache = aClient.getMetadataCache(aTableDatasource);
        if (mdCache != null) {
     ...
     */
    public static final ResourceBundle DbLocalizations = ResourceBundle.getBundle("com/eas/databases/DbLocalizations");
    ...
    public static SqlQuery constructQueryByTableName(Databases aClient, String aTableName) {
        if (aTableName != null) {
