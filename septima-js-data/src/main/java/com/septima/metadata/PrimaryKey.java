...
public class PrimaryKey {
    ...
    /**
     * Copy contructor.
     * @param aSource <code>PrimaryKey</code> instance to be used as information source.
     */
    protected PrimaryKey(PrimaryKey aSource) {
        super();
        if (aSource != null) {
     ...
     * @return Copied <code>PrimaryKey</code> instance.
     * @see #PrimaryKey(PrimaryKey aSource)
     */
