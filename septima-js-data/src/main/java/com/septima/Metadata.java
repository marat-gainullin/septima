...
import com.septima.client.metadata.DbTableIndexes;
import com.septima.client.metadata.DbTableKeys;
...
public class Metadata implements StatementsGenerator.TablesContainer {
    ...
    public Metadata(Databases aClient, String aDatasourceName) throws Exception {
        super();
        client = aClient;
